...
const SignInWithGoogle = React.lazy(() =>
  import(
    "../components/components/SignInSignUp/SignInWithGoogle/SignInWithGoogle"
  )
);
const ConfirmAccount = React.lazy(() =>
  import("../components/components/SignInSignUp/ConfirmAccount/ConfirmAccount")
);
...
const routes = [
  ...
  { id: 12, path: "/checklist/:id", element: <ChecklistReviewPage /> },
  {
    id: 13,
  ...
  { id: 19, path: "/saved-checklists", element: <AllChecklistsPage /> },
  { id: 20, path: "/liked-checklists", element: <AllChecklistsPage /> },
  { id: 21, path: "/created-checklists", element: <AllChecklistsPage /> },
  ...
  { id: 31, path: "/confirmation", element: <ConfirmAccount /> },
